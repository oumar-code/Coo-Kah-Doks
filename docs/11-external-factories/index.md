...
```mermaid
graph LR
    T1["Tier 1 — Local Champions\nNW Nigeria\nMonths 1–6"]
    T2["Tier 2 — Multinational Subsidiaries\nNestle Nigeria, MTN\nMonths 4–9"]
    T3["Tier 3 — Global Multinationals\nNestle Switzerland, Siemens\nMonths 9–12+"]

    T1 -->|"2 case studies"| T2
    T2 -->|"5 pilots + $100K revenue"| T3
```
