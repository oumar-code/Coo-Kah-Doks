...
| **Factory Repository** | `coo-cah-factory-chemicals-metallurgical` |
| **Registration Reference** | `orchestration/factory-status-registry.md` (in Coo-Kah-Doks) |
| **Vertical** | Chemicals |
| **Sub-vertical** | Metallurgical — Steel rolling, aluminium extrusion, copper drawing |
...
| ISO 14001:2015 — Environmental | `docs/standards/iso-14001.md` | [docs/regulatory.md](./regulatory.md) |
| ISO 50001:2018 — Energy | `docs/standards/iso-50001.md` | [docs/energy-profile.md](./energy-profile.md) |
...
- ✅ **MES integration**: This factory adopts the group MES integration standard; all production
  data, heat records, and coil/batch tracking flow to the group MES platform as specified in
...
- ✅ **Regulatory framework**: NESREA EIA, Ministry of Mines registration, SON NIS, and DPR/NUPRC
...
| 1.1 | 2026-05 | Blueprint alignment v1.0 — added docs/index.md, docs/master-repo-ref.md, fixed mkdocs.yml and README.md | Blueprint Sync |
...
| `coo-cah-factory-consumer-goods-*` | Customers — aluminium packaging components |
