# Food Beverages — Process Flow Diagram
...
End-to-end production process flow for **Food Beverages**. Stage IDs MUST align with MES workflow definitions in [`mes-integration.md`](../../mes-integration.md). Zone IDs MUST match [`floor-plan.md`](../../floor-plan.md).
