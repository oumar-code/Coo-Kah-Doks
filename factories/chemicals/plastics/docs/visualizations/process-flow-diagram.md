...
End-to-end production process flow for **Plastics**. Stage IDs MUST align with MES workflow definitions in [`mes-integration.md`](../../mes-integration.md). Zone IDs MUST match [`floor-plan.md`](../../floor-plan.md).
