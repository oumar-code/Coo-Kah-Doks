# Heavy Chemicals — Process Flow Diagram
...
End-to-end production process flow for **Heavy Chemicals**. Stage IDs MUST align with MES workflow definitions in [`mes-integration.md`](../../mes-integration.md). Zone IDs MUST match [`floor-plan.md`](../../floor-plan.md).
