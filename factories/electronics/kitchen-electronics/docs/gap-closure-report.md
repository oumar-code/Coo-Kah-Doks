...
| G-005  | `docs/intragroup-supply-coordination.md` exists; Plastics casing volumes confirmed; Garage Power inverter allocation agreed | Supply Chain Lead |
| G-006  | `docs/pentest-scoping.md` exists; Digital Encode Limited named; R600a sub-VLAN exclusion rule defined | IT Security Lead |
